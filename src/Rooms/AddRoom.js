...
export default function AddRoom() {
       ...
       const{rid,ac,status,bedType,checkStatus,facilities,location,roomType,serviceType}=room;
        ...
        <div class="containe">
            ...
            <div class="col">
                ...
                <div className="container1">
                   ...
                   <button type="submit" class="btn btn-primary mb-3 ms-3 mt-3 btn-lg" >Add a room</button>
                   <Link type="submit" class="btn btn-danger mb-3 ms-3 mt-3 btn-lg" to="/viewrooms" >Cancel</Link>
